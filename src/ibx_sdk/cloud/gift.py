...
class Gift:
    ...
    def _call(self, method: str, path: str, **kwargs) -> httpx.Response:
        ...
        # Construct the full URL by combining base_url and path
    ...
    def get(self, path: str, **kwargs) -> httpx.Response:
        ...
        Example:
            >>> client = Gift(api_key="YOUR_TOKEN", base_url="https://csp.infoblox.com")
            >>> client.connect()
            >>> response = client.get("/api/ddi/v1/dns/view", params={"_limit": 10})
            >>> print(response.json())
        """
    ...
    def get_paginated(
        ...
        while True:
            ...
            # Stop if the response is not a list
            ...
            # If fewer items than the limit are returned, we've reached the end
