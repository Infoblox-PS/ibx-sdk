...
class AliasRecord(BaseModel):
    ...
    new_target_type: Optional[TargetRecordTypeEnum] = Field(alias="_new_target_type", default=None)
    comment: Optional[str] = None
    ttl: Optional[PositiveInt] = None
    disabled: Optional[bool] = None
    view: Optional[str] = None
...
class TLSARecord(BaseModel):
    ...
    new_certificate_data: Optional[str] = Field(alias="_new_certificate_data", default=None)
    comment: Optional[str] = None
    ttl: Optional[PositiveInt] = None
    fqdn: str
    new_fqdn: Optional[str] = Field(alias="_new_fqdn", default=None)
...
class HostRecord(BaseModel):
    ...
    new_configure_for_dns: Optional[bool] = Field(alias="_new_configure_for_dns", default=None)
    comment: Optional[str] = None
    disabled: Optional[bool] = None
    ttl: Optional[PositiveInt] = None
...
class Ipv6HostAddress(BaseModel):
    ...
    import_action: Optional[ImportActionEnum] = Field(alias="import-action", default=None)
    parent: str
    address_type: Optional[IPv6AddressTypeEnum] = Field(default=IPv6AddressTypeEnum.ADDRESS)
    address: IPv6Address
    new_address: Optional[IPv6Address] = Field(alias="_new_address", default=None)
    ipv6_prefix: Optional[PositiveInt] = Field(ge=0, le=128, default=64)
    new_ipv6_prefix: Optional[PositiveInt] = Field(alias="_new_ipv6_prefix", default=None)
