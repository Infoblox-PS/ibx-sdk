...
def test_ipv4networkcontainer_mandatory_fields():
    ...
    container = IPv4NetworkContainer(
        address=IPv4Address("192.168.0.1"), netmask=IPv4Address("255.255.255.0")
    )
...
def test_ipv4networkcontainer_invalid_field_exception():
    ...
    container = IPv4NetworkContainer(
        address=IPv4Address("192.168.1.0"), netmask=IPv4Address("255.255.255.0")
    )
...
def test_ipv4networkcontainer_valid_custom_field():
    ...
    container = IPv4NetworkContainer(
        address=IPv4Address("10.0.0.1"), netmask=IPv4Address("255.255.255.0")
    )
...
def test_ipv4networkcontainer_invalid_address():
    ...
    with pytest.raises(ValueError):
        IPv4NetworkContainer(address="invalid-ip", netmask=IPv4Address("255.255.255.0"))
...
def test_ipv4networkcontainer_invalid_netmask():
    ...
    with pytest.raises(ValueError):
        IPv4NetworkContainer(
            address=IPv4Address("192.168.1.1"), netmask="invalid-netmask"
        )
